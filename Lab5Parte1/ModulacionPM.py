...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Modulación PM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulación PM")
        ...
        # Blocks
        ##################################################
        self._kp_range = Range(0, 20, 0.000001, 1, 200)
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Espectro de la Señal Modulada", #name
            1,
            None # parent
        )
