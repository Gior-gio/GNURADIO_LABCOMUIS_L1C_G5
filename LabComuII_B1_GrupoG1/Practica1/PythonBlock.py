...
class PythonBlock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PythonBlock", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PythonBlock")
        ...
        labels = ['Media:', 'Media Cuadratica:', 'RMS', 'Potencia Media', 'Desviacion Estandar',
            '', '', '', '', '']
        units = ['', '', '', '', '',
            '', '', '', '', '']
        ...
        self.epy_block_0 = epy_block_0.blk(size=1)
