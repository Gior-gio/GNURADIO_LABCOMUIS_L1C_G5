...
class Practica1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica1")
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(0, 5)
        ...
        self.connect((self.blocks_int_to_float_0, 0), (self.blocks_throttle_0_0, 0))
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_throttle_0_1, 0))
