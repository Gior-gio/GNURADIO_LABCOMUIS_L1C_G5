...
class Lab_comu_II(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comu_II")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(1000, 32000, 100, 1000, 200)
...
def main(top_block_cls=Lab_comu_II, options=None):
