...
import SegundoLAB_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
...
class SegundoLAB(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SegundoLAB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SegundoLAB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SegundoLAB")
        ...
        self.h = h = np.ones((Sps,), dtype = int)
        self.N = N = 1024
        ...
        self.fft_vxx_1 = fft.fft_vfc(1024, True, [1]*N, True, 1)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vff([1/(N*samp_rate)]*N)
    ...
    def set_Sps(self, Sps):
        self.Sps = Sps
        self.set_h(np.ones((self.Sps,), dtype = int) )
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k([1/(self.N*self.samp_rate)]*self.N)
...
def main(top_block_cls=SegundoLAB, options=None):
